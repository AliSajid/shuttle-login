...
const setup_api_keys_1 = __nccwpck_require__(961);
function run() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.place_api_key = void 0;
const core = __importStar(__nccwpck_require__(733));
const fs = __importStar(__nccwpck_require__(147));
const TOML = __importStar(__nccwpck_require__(443));
const path = __importStar(__nccwpck_require__(17));
function place_api_key(api_key) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config_base_dir = process.env.XDG_CONFIG_HOME || `${process.env.HOME}/.config`;
        core.debug(`config_base_dir: ${config_base_dir}`);
        const config_path = `${config_base_dir}/shuttle/config.toml`;
        const input_data = {
            api_key
        };
        const toml_data = TOML.stringify(input_data, { newline: '\n' });
        ...
        try {
            ...
            yield fs.promises.writeFile(config_path, toml_data);
...
exports.place_api_key = place_api_key;
...
const parse = (source        , specificationVersion                                   , multilineStringJoiner                                                                                                                       , bigint                                       , x                              , argsMode                 )        => {
	...
	if ( typeof source==='object' && source ) {
		if ( isArray$1(source) ) { throw TypeError$1(isLinesFromStringify(source) ? `TOML.parse(array from TOML.stringify(,{newline?}))` : `TOML.parse(array)`); }
			...
			const { data, require: req =  true ? require : 0 } = source;
			if ( req ) {
				const { resolve } = req;
				if ( resolve!=null ) {
					const { paths } = resolve;
